...
/**
 * @var $gdt GDT_GraphSelect
 */
?>
<form <?=$gdt->htmlID()?> class="gdt-graph-select">
    <div class="gdo-jpgraph">
		<?php
		if (!$gdt->withoutDateInput) : ?>
            <div class="gdo-jpgraph-selection">
				<?php
				echo GDT_GraphDateselect::make('date')->withToday($gdt->withToday)->withYesterday($gdt->withYesterday)->initial('7days')->render(); ?>
